...
The demo script will download an off-the-shelf ResNet101-based model, if you haven't done so. You can also download other off-the-shelf models based on different architectures below: 
