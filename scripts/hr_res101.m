...
%% select a higher threshold to prevent messy visualization
if vis, probThresh = 0.5;
else, probThresh = 0.03;
end
...
switch mode
  ...
  case 'eval'
    for i = 47
      cnn_widerface_eval_new('testMultires', true, ...
                             'testSize', testSize, ...
                             'noUpsampling', false, ...
                             'noOrgres', false, ...
                             'noDownsampling', false, ...
  ...
  case 'range'
    for ci = 1:25
      for i = 36:50
        cnn_widerface_eval_range('clusterSet', [ci], ...
                                 'testMultires', true, ...
                                 'testSize', testSize, ...
                                 'noUpsampling', false, ...
                                 'noOrgres', false, ...
